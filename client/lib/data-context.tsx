...
const sampleTasks: Task[] = [
  ...
  },
  {
    ...
    endDate: `${currentYear}-${String(currentMonth + 3).padStart(2, "0")}-15`,
    dueDate: `${currentYear}-${String(currentMonth + 3).padStart(2, "0")}-15`,
    trade: "Concrete",
    priority: "high",
    media: [],
    phaseId: "phase-1",
  ...
  },
  {
    ...
    status: "in-progress",
    startDate: `${currentYear}-${String(currentMonth + 3).padStart(2, "0")}-16`,
    endDate: `${currentYear}-${String(currentMonth + 4).padStart(2, "0")}-30`,
    dueDate: `${currentYear}-${String(currentMonth + 4).padStart(2, "0")}-30`,
    trade: "Steel Work",
    priority: "high",
    media: [],
    phaseId: "phase-2",
  ...
  },
  {
    ...
    progress: 20,
    status: "in-progress",
    startDate: `${currentYear}-${String(currentMonth + 4).padStart(2, "0")}-15`,
    endDate: `${currentYear}-${String(currentMonth + 6).padStart(2, "0")}-15`,
    dueDate: `${currentYear}-${String(currentMonth + 6).padStart(2, "0")}-15`,
    trade: "Electrical",
    priority: "medium",
    media: [],
    phaseId: "phase-2",
  ...
  },
  {
    ...
    progress: 10,
    status: "planned",
    startDate: `${currentYear}-${String(currentMonth + 5).padStart(2, "0")}-01`,
    endDate: `${currentYear}-${String(currentMonth + 6).padStart(2, "0")}-30`,
    dueDate: `${currentYear}-${String(currentMonth + 6).padStart(2, "0")}-30`,
    trade: "HVAC",
    priority: "medium",
    media: [],
    phaseId: "phase-2",
  ...
  },
  {
    ...
    status: "planned",
    startDate: `${currentYear}-${String(currentMonth + 6).padStart(2, "0")}-01`,
    endDate: `${currentYear}-${String(currentMonth + 7).padStart(2, "0")}-15`,
    dueDate: `${currentYear}-${String(currentMonth + 7).padStart(2, "0")}-15`,
    trade: "Painting",
    priority: "low",
    media: [],
    phaseId: "phase-3",
